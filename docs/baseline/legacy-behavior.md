...
| Cancellation | Not verified | No reliable typed cancellation lifecycle was established in the reviewed main-process bridge. | M1 defines task states and cancellation semantics; consolidated M3 must implement process termination and recovery. |
